...
```xml
<dependency>
    <groupId>com.github.claremontqualitymanagement.java.com.zingtongroup.loggingseleniumwebdriver.LoggingSeleniumWebDriver</groupId>
    <artifactId>java.com.zingtongroup.loggingseleniumwebdriver.LoggingSeleniumWebDriver</artifactId>
...
```java
    WebDriver driver = new java.com.zingtongroup.loggingseleniumwebdriver.LoggingSeleniumWebDriver(new ChromeDriver()); //Enables console logger by default
```
### Builder pattern constructor
```java
        WebDriver driver = new java.com.zingtongroup.loggingseleniumwebdriver.LoggingSeleniumWebDriver.Builder()
...
```java
        java.com.zingtongroup.loggingseleniumwebdriver.LoggingSeleniumWebDriver driver = new java.com.zingtongroup.loggingseleniumwebdriver.LoggingSeleniumWebDriver(new FirefoxDriver());
...
If not used as a WebDriver, but kept as a java.com.zingtongroup.loggingseleniumwebdriver.LoggingSeleniumWebDriver you may add other loggers and custom loggers:
```java
    java.com.zingtongroup.loggingseleniumwebdriver.LoggingSeleniumWebDriver driver = new java.com.zingtongroup.loggingseleniumwebdriver.LoggingSeleniumWebDriver(new ChromeDriver());
